<section class="home-contact">
    <div class="grid">
        <div class="col col-12-sm col-6-md col-5 bg-color-2 home-contact__title-cont border-r border-l">
        ...
        <div class="home-contact__body-cont col col-12-sm col-6-md col-7 flex padding-right border-l">
            ...
            <div class="home-contact__icon">
                <ul class="align-ul">
                    ...
                    <li><a href="https://www.behance.net/shayparksooin" target="_blank"><img src="/img/Behance.svg" alt="Shay's Behance"></a></li>
                    <li><a href="https://www.instagram.com/shaypark.edits/" target="_blank"><img src="/img/InstagramFilled.svg" alt="Shay's Instagram Profile"></a></li>
                    <li><a href="mailto:shayparksooin@gmail.com" target="_blank"><img src="/img/MailFilled.svg" alt="Shay's Email"></a></li>
                </ul>
            </div>
        </div>
    </div>
